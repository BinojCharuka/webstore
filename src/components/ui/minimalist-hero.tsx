...
export const MinimalistHero = ({
  ...
  return (
    <div
      className={cn(
        'relative flex h-screen w-full flex-col items-center justify-between overflow-hidden bg-[#111111] p-8 font-sans md:p-12',
        className
      )}
    >
      ...
      <div className="relative grid w-full max-w-7xl flex-grow grid-cols-1 items-center md:grid-cols-3">
        ...
        >
          <div className="mx-auto max-w-[600px] md:mx-0 w-full text-left md:text-right">
            <WarpText
              text={mainText}
        ...
        <div className="relative order-1 md:order-2 flex justify-center items-center h-full">
            ...
            <motion.div
                ...
                className="absolute z-0 h-[300px] w-[300px] rounded-full bg-[#aaff00]/90 md:h-[400px] md:w-[400px] lg:h-[500px] lg:w-[500px]"
            ></motion.div>
            ...
            <div className="glitch-wrapper relative z-10 flex justify-center items-center">
              <motion.img
                  src={imageSrc}
                  alt={imageAlt}
                  className="h-[500px] w-auto object-cover md:h-[600px] lg:h-[700px] scale-[1.2]"
        ...
        <motion.div
          ...
          className="z-0 order-3 flex items-center justify-center text-center md:justify-start w-full max-w-[600px]"
        >
          <WarpText
      ...
      {/* Footer Elements */}
      <footer className="z-30 flex w-full max-w-7xl items-center justify-between text-white">
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
